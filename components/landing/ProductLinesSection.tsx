...
// Todas las líneas de productos aplanadas (sin agrupación)
const productLines = [
  {
    name: 'LÍNEA SINTÉTICA',
    slug: 'linea-sintetica',
...
const ProductLinesSectionContent = () => {
  ...
  // Scroll suave al hacer click en links de anchor
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Product Lines - Todas visibles sin agrupación */}
        <div className="space-y-12">
          {productLines.map((product, productIndex) => (
            <motion.div
              key={product.slug}
              id={product.slug}
              className="scroll-mt-24 rounded-xl border border-gray-600/30 bg-gray-900/50 p-8"
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="grid gap-6 lg:gap-8 lg:grid-cols-5">
                ...
                <div className="lg:col-span-3">
                  ...
                  <div className="mb-6 flex items-start gap-4">
                    <div className={`h-14 w-14 flex-shrink-0 rounded-full bg-gradient-to-r ${product.gradient} p-3`}>
                      <product.icon className="h-full w-full text-white" />
                    </div>
                    <div className="flex-1">
                      <h3 className="mb-2 text-2xl font-bold text-[#16a245] lg:text-3xl">
                        {product.name}
                      </h3>
              ...
              <div className="mt-8 border-t border-gray-600/30 pt-8">
                <div className="grid gap-8 lg:grid-cols-2">
                  <div>
                    <h4 className="mb-4 flex items-center gap-3 text-xl font-semibold text-white">
                  ...
                  <div>
                    {product.applications && (
                      <div>
                        <h5 className="mb-3 flex items-center gap-2 text-lg font-semibold text-gray-200">
